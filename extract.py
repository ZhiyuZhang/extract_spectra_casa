...
#  casa-pip install photutils
#  casa-pip install copy 
#-----------------------------------------------------------
...
# -----------   list of the files     ---------- 
filelist=[ 'G09-81106-100.ms.dirty.image',   # 0 
           'G09-83808-100.ms.dirty.image',   # 1
          'NGP-111912-100.ms.dirty.image',   # 2
          'NGP-126191-100.ms.dirty.image',   # 3
          'NGP-190387-100.ms.dirty.image',   # 4 
          'NGP-246114-100.ms.dirty.image',   # 5 
          ]

#         'G15-26675-100.ms.dirty.image',  'G15-82684-100.ms.dirty.image',
#         'NGP-101333-100.ms.dirty.image', 'NGP-113609-100.ms.dirty.image',
#         'NGP-136156-100.ms.dirty.image', 'NGP-206987-100.ms.dirty.image',
#         'NGP-252305-100.ms.dirty.image', 'NGP-63663-100.ms.dirty.image']


location=['08h49m36.82s, 00d14m54.7s', # 0
          '09h00m45.79s, 00d41m22.9s', # 1
          '13h08m24.04s, 25d45m17.9s', # 2
          '13h32m17.82s, 34d39m50.5s', # 3
          '13h33m37.47s, 24d15m39.3s', # 4
          '13h41m14.09s, 33d59m38.2s', # 5
           ] 


AperDiameter = 3 # arcsec 
k            = 5 # the number in the filelist and associated location 
